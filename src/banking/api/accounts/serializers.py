...
from banking.module.accounts.models import AccountInformation, AccountStatement
from banking.module.users.models import Customer
from banking.module.accounts.tasks import on_commit
...
class TransactionsSerializer(serializers.ModelSerializer):
    banking_info = serializers.CharField(source='banking_info.account_number')
...
class DepositTransactionsSerializer(serializers.Serializer):
    ...
    def create(self, validated_data):
        ...
        deposit = on_commit(
            sender=sender,
            banking_info=sender.accountinformation,
            receiver=sender,
